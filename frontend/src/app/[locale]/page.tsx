...
function LandingContent() {
  ...
  const PLANS: Plan[] = [
    { name: "Free Trial",   slug: "free",         cta: t("pricing.plans.freeCta"),         popular: false, trial: true },
    { name: "Starter",      slug: "starter",      cta: t("pricing.plans.starterCta"),      popular: false },
    { name: "Professional", slug: "professional", cta: t("pricing.plans.professionalCta"), popular: true  },
    { name: "Enterprise",   slug: "enterprise",   cta: t("pricing.plans.enterpriseCta"),   popular: false },
  ];

  // Banner filename prefix: /stripe/it/... vs /stripe/en/... (IT is default)
  const bannerPrefix = locale === "en" ? "/stripe/en" : "/stripe";
    ...
    <div className="min-h-screen bg-linear-to-br from-brand-navy via-brand-navy-light to-brand-navy-deep text-white">
      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-3">
          <LanguageSwitcher />
          <Link href="/login" className="text-[13px] text-white/60 hover:text-white transition-colors">{t("nav.login")}</Link>
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 text-center">
        ...
        <h1 className="relative mx-auto max-w-3xl text-[48px] font-semibold leading-tight tracking-tight">
          {t("hero.titleLead")}{" "}
          <span className="text-brand-teal">{t("hero.titleAccent")}</span>
        </h1>
        ...
        <div className="relative mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[12px] text-brand-slate-muted">
          <span className="inline-flex items-center gap-1.5">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-3.5 w-3.5 text-brand-green">
              <rect x="3" y="8" width="18" height="13" rx="2" strokeLinecap="round"/>
              <path d="M12 8v13M3 12h18M8 8a3 3 0 0 1 0-6c2 0 4 3 4 6M16 8a3 3 0 0 0 0-6c-2 0-4 3-4 6" strokeLinecap="round"/>
            </svg>
            <span className="text-brand-green">{t("hero.statTrial")}</span>
          </span>
          <span className="h-3 w-px bg-white/15" />
          <span className="inline-flex items-center gap-1.5">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-3.5 w-3.5 text-brand-teal">
              <rect x="2" y="6" width="20" height="13" rx="2"/>
              <path d="M2 11h20M6 15h3" strokeLinecap="round"/>
            </svg>
            {t("hero.statCard")}
          </span>
          <span className="h-3 w-px bg-white/15" />
          ...
          <span className="h-3 w-px bg-white/15" />
          <span className="inline-flex items-center gap-1.5">
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5 text-brand-teal">
              <path d="M12 2l1.5 4.5L18 8l-4.5 1.5L12 14l-1.5-4.5L6 8l4.5-1.5L12 2zM19 14l1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3z"/>
            </svg>
            {t("hero.statClaude")}
          </span>
        </div>
      ...
      <section className="relative overflow-hidden border-t border-white/10 py-24">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          ...
          <h2 className="mx-auto max-w-3xl text-center text-[38px] font-semibold leading-[1.15] tracking-tight">
            {t("aiSpotlight.titleLead")} <span className="text-brand-teal">{t("aiSpotlight.titleAccent")}</span>{t("aiSpotlight.titleTail")}
          </h2>
          <p className="mx-auto mt-5 max-w-2xl text-center text-[16px] leading-relaxed text-brand-slate-light">
            {t("aiSpotlight.subtitleLead")} <strong className="text-white">{t("aiSpotlight.subtitleBold")}</strong> {t("aiSpotlight.subtitleMid")}{" "}
            <strong className="text-brand-teal">{t("aiSpotlight.subtitleAccent")}</strong> {t("aiSpotlight.subtitleTail")}
          </p>

          <div className="mt-14 grid grid-cols-4 gap-5">
            {[
              {
                title: t("aiSpotlight.cards.copyTitle"),
                desc: t("aiSpotlight.cards.copyDesc"),
                icon: (
              ...
              {
                title: t("aiSpotlight.cards.segmentTitle"),
                desc: t("aiSpotlight.cards.segmentDesc"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
              ...
              {
                title: t("aiSpotlight.cards.languageTitle"),
                desc: t("aiSpotlight.cards.languageDesc"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
              ...
              {
                title: t("aiSpotlight.cards.learnTitle"),
                desc: t("aiSpotlight.cards.learnDesc"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-6 text-[13px] text-brand-slate-muted">
            <span className="inline-flex items-center gap-2">
              ...
              <span>{t("aiSpotlight.statTimePrefix")}</span>
              <strong className="text-white">{t("aiSpotlight.statTimeValue")}</strong>
            </span>
            <span className="h-3 w-px bg-white/15" />
            <span className="inline-flex items-center gap-2">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-brand-teal" />
              <span>{t("aiSpotlight.statResponsePrefix")}</span>
              <strong className="text-white">{t("aiSpotlight.statResponseValue")}</strong>
            </span>
            <span className="h-3 w-px bg-white/15" />
            <span className="inline-flex items-center gap-2">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-brand-teal" />
              <strong className="text-white">{t("aiSpotlight.statSpamValue")}</strong>
              <span>{t("aiSpotlight.statSpamSuffix")}</span>
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-white/10 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="mb-3 text-center text-[28px] font-semibold">{t("howItWorks.title")}</h2>
          <p className="mb-12 text-center text-[14px] text-brand-slate-light">{t("howItWorks.subtitle")}</p>
      ...
      <section className="border-t border-white/10 py-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-5 flex justify-center">
            <span className="inline-flex items-center gap-2 rounded-pill border border-brand-teal/30 bg-brand-teal/10 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-widest text-brand-teal">
              {t("autoSelection.badge")}
            </span>
          </div>
          <h2 className="mb-4 text-center text-[32px] font-semibold leading-[1.15] tracking-tight">
            {t("autoSelection.titleLead")} <span className="text-brand-teal">{t("autoSelection.titleAccent")}</span> {t("autoSelection.titleTail")}
          </h2>
          <p className="mx-auto mb-14 max-w-2xl text-center text-[15px] leading-relaxed text-brand-slate-light">
            {t("autoSelection.subtitleLead")} <strong className="text-white">{t("autoSelection.subtitleBold")}</strong>{t("autoSelection.subtitleTail")}
          </p>

          <div className="grid grid-cols-3 gap-6">
            {[
              {
                tag: t("autoSelection.tier1Tag"),
                title: t("autoSelection.tier1Title"),
                desc: t("autoSelection.tier1Desc"),
                credits: t("autoSelection.tier1Credits"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
              ...
              {
                tag: t("autoSelection.tier2Tag"),
                title: t("autoSelection.tier2Title"),
                desc: t("autoSelection.tier2Desc"),
                credits: t("autoSelection.tier2Credits"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
              ...
              {
                tag: t("autoSelection.tier3Tag"),
                title: t("autoSelection.tier3Title"),
                desc: t("autoSelection.tier3Desc"),
                credits: t("autoSelection.tier3Credits"),
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6">
                    <path d="M9 2c-2.5 0-4 2-4 4 0 1.5.5 2.5 1.5 3.5-.8 1-1.5 2-1.5 3.5 0 2 1.5 4 4 4"/>
                    <path d="M15 2c2.5 0 4 2 4 4 0 1.5-.5 2.5-1.5 3.5.8 1 1.5 2 1.5 3.5 0 2-1.5 4-4 4"/>
                    <path d="M9 2h6M9 17h6M12 2v15M12 17v5"/>
                  </svg>
                ),
              },
            ].map((b) => (
              <div key={b.tag} className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-colors hover:border-brand-teal/40">
                <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-lg bg-brand-teal/15 text-brand-teal">
                  {b.icon}
                </div>
                <div className="mb-1 text-[10px] font-semibold uppercase tracking-widest text-brand-teal">{b.tag}</div>
                <h3 className="mb-2 text-[16px] font-semibold text-white">{b.title}</h3>
                <p className="mb-4 text-[13px] leading-relaxed text-brand-slate-light">{b.desc}</p>
                <div className="inline-flex items-center rounded-md border border-white/10 bg-white/5 px-2.5 py-1 text-[11px] font-mono text-brand-slate-light">
                  {b.credits}
                </div>
              </div>
            ))}
          ...
          <p className="mt-10 text-center text-[13px] text-brand-slate-muted">
            {t("autoSelection.footnote")}
          </p>
        </div>
      </section>
      ...
      <section id="pricing" className="border-t border-white/10 py-20">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="mb-3 text-center text-[28px] font-semibold">{t("pricing.title")}</h2>
          <p className="mb-6 text-center text-[14px] text-brand-slate-light">{t("pricing.subtitle")}</p>
            ...
            {PLANS.map((plan) => {
              ...
              return (
                <div key={plan.name} className={`flex flex-col overflow-hidden rounded-2xl ${wrapperRing}`}>
                  <img
                    src={`${bannerPrefix}/wamply-${plan.slug}-banner.png`}
      ...
      <section id="faq" className="border-t border-white/10 py-20">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="mb-3 text-center text-[28px] font-semibold">{t("faq.title")}</h2>
            ...
            {[
              {
                ...
                a: (
                  <>
                    {t("faq.q1AnswerP1")}
                    <br /><br />
                    {t("faq.q1AnswerP2Pre")} <strong className="text-white">{t("faq.q1AnswerP2ProfName")}</strong> {t("faq.q1AnswerP2Mid")}{" "}
                    <strong className="text-brand-teal">{t("faq.q1AnswerP2ProfCredits")}</strong>{t("faq.q1AnswerP2Comma")}{" "}
                    <strong className="text-brand-teal">{t("faq.q1AnswerP2EntName")}</strong>{t("faq.q1AnswerP2End")}
                  </>
                ),
              },
              {
                ...
                a: (
                  <>
                    {t("faq.q2AnswerP1Pre")} <strong className="text-white">{t("faq.q2AnswerP1StarterName")}</strong> {t("faq.q2AnswerP1Mid")}{" "}
                    <strong className="text-white">{t("faq.q2AnswerP1Bold")}</strong> {t("faq.q2AnswerP1Tail")}
                    <br /><br />
                    {t("faq.q2AnswerP2")}
                  </>
                ),
              },
              {
                ...
                a: (
                  <>
                    {t("faq.q3AnswerP1Pre")} <strong className="text-white">{t("faq.q3AnswerP1Bold")}</strong> {t("faq.q3AnswerP1Tail")}
                    <br /><br />
                    {t("faq.q3AnswerP2Pre")} <strong className="text-brand-teal">{t("faq.q3AnswerP2Accent")}</strong> {t("faq.q3AnswerP2Tail")}
                  </>
                ),
              },
            ].map((f, i) => (
              <details key={i} className="group rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm transition-colors open:border-brand-teal/40 open:bg-white/8">
                <summary className="flex cursor-pointer items-center justify-between px-6 py-4 text-[15px] font-medium text-white list-none [&::-webkit-details-marker]:hidden">
                  <span>{f.q}</span>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5 shrink-0 text-brand-slate-muted transition-transform duration-200 group-open:rotate-180">
                    <polyline points="6 9 12 15 18 9" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </summary>
                <div className="px-6 pb-5 text-[14px] leading-relaxed text-brand-slate-light">
                  {f.a}
                </div>
              </details>
            ))}
          ...
          <p className="mt-10 text-center text-[13px] text-brand-slate-muted">
            {t("faq.contactPrompt")}{" "}
            <a href="mailto:admin@agentengineering.it" className="text-brand-teal hover:underline">
              {t("faq.contactLink")}
            </a>{" "}
            {t("faq.contactSuffix")}
          </p>
      ...
      <footer className="border-t border-white/10 bg-brand-navy-deep py-6">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-x-6 gap-y-3 px-6 text-[12px] text-brand-slate-muted">
          ...
          <div className="flex flex-wrap items-center gap-x-3.5 gap-y-2">
            <span className="inline-flex items-center" title={t("footer.stripeLabel")}>
            ...
            <span className="text-white/60">PCI DSS · 3D Secure · TLS 1.3</span>
            <span className="h-3 w-px bg-white/10" />
            <span className="inline-flex items-center gap-1.5" title={t("footer.claudeLabel")}>
              ...
              <span className="text-white/60">{t("footer.claudeLabel")}</span>
            </span>
          </div>
